...
color_button_calculate = (255, 255, 255)
...
margin_for_button_calculate = 10
margin_for_button_calculate = 120
        ...
        for i in range(len(points)):
            ...
            for g in range(len(tools.coof)):
                ...
                if min_dist > dist:
                    ...
                    index = g
            #print(index)
            if min_dist > maximum_dist_from_solution:
                pygame.draw.circle(screen, far_color, (center_x + dubl_points[i][0] * scale, center_y + dubl_points[i][1] * scale), size_of_points, 100)
            else:
                pygame.draw.circle(screen, tools.colors[index], (center_x + dubl_points[i][0] * scale, center_y + dubl_points[i][1] * scale), size_of_points, 100)
